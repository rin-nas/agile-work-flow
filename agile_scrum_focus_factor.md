...
* Чтобы коллегам из бизнес-подразделения понять, за сколько примерно календарных часов будет сделана задача, нужно время оценки умножить на 1.3333 (для оптимистичного фокус-фактора). Докажем продуктовым менеджерам, что фокус-фактор есть на самом деле. Разделим задачи на неосновные и основные.
